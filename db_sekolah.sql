...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2021 at 05:19 AM
...
(40, 2003, 'Teguh Budi', 'Ijazah', 'proses', 'Penjelasan PPT Jarkom.docx'),
(41, 2003, 'Teguh Budi', 'Ijazah 2', 'selesai', '10.1109@ICESC48915.2020.9155846.en.id.pdf'),
(42, 2002, 'Yoga Tirta', 'SKHUN', 'pending', 'nadir2018.en.id.pdf'),
...
--
ALTER TABLE `tbl_simpan`
  MODIFY `id_simpan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=62;
